    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9fc] dark:bg-[#0a0f1e] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-xl shadow-gray-100 dark:shadow-black/30">
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-7">Commencez à suivre votre progression</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-1.5">Mot de passe</label>
              ...
              {password && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-400 dark:text-slate-500">{strengthLabel[s]} mot de passe</p>
                </div>
              )}
            </div>
